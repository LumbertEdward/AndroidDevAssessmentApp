...
public class HighestPriceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_highest_price, container, false);
        recyclerView = view.findViewById(R.id.recyclerExpensive);
        back = view.findViewById(R.id.relBackHigh);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    for (DataSnapshot dataSnapshot: snapshot.getChildren()){
                        ...
                        car.setAmnt(dataSnapshot.child("amnt").getValue().toString());

                        if (Integer.parseInt(car.getAmnt()) >= 4000){
                            cars.add(car);
                        }
                    }
