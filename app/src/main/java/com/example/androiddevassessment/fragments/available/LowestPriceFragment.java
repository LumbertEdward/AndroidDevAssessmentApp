...
public class LowestPriceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lowest_price, container, false);
        recyclerView = view.findViewById(R.id.recyclerAffordable);
        back = view.findViewById(R.id.relBackCheap);
